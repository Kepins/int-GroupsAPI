...
class User(Base):
    ...
    groups_admin: Mapped[List["Group"]] = relationship(
        back_populates="admin", primaryjoin=lambda: User.id == Group.admin_id
    )
...
class Group(Base):
    ...
    admin: Mapped["User"] = relationship(
        back_populates="groups_admin", foreign_keys=[admin_id]
    )
...
class Event(Base):
    ...
    group: Mapped["Group"] = relationship(
        back_populates="events", foreign_keys=[group_id]
    )
